...
public class TestSQLSubstituteBackMetaAtomIntoMolecule {
	...
	public void NancyLinearFormTest() {
		System.out.println("NancyLinearFormTest");
		ThermoSQLConnection connection = new ThermoSQLConnection();
		System.out.println("NancyLinearFormTest open connection");
		if (connection.connect()) {
			try {
				System.out.println("NancyLinearForm: SQL");
				String nancy = new String("NancyLinearForm");
				SQLSubstituteBackMetaAtomIntoMolecule substitute = new SQLSubstituteBackMetaAtomIntoMolecule(nancy,
						connection);
