...
public class SetOfMetaAtomsForSubstitution extends ArrayList<SubstituteMetaAtom> {
     ...
     * @throws IOException
     */
    public IAtomContainer substitute(StructureAsCML struct) throws CDKException, ClassNotFoundException, IOException {
        NormalizeMoleculeFromCMLStructure norm = new NormalizeMoleculeFromCMLStructure();
        IAtomContainer molecule = norm.getNormalizedMolecule(struct);
