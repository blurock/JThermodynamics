...
public class BuildBensonThermodynamicFromThergas {
    ...
    public IAtomContainer buildMolecule(JThermgasThermoStructureDataPoint thergasbase, ThermoSQLConnection c) throws CDKException, SQLException {
        ...
        IAtomContainer mol = nancy.convert(linearform);
