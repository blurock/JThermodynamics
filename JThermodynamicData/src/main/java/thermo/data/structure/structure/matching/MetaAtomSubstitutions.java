 ...
 * @author blurock
 */
public class MetaAtomSubstitutions implements Comparable<MetaAtomSubstitutions> {
     ...
     */
    public int compare(MetaAtomSubstitutions sub1, MetaAtomSubstitutions sub2) {
        int comp = 0;
     ...
     * @return
     */
    public int compareTo(MetaAtomSubstitutions o) {
