...
public class QueryBondWithMetaAtoms extends OrderQueryBond {
	...
	public QueryBondWithMetaAtoms(IQueryAtom atom1, IQueryAtom atom2, Order order, IChemObjectBuilder builder) {
		super(atom1, atom2, order, builder);
	}
    public QueryBondWithMetaAtoms(IChemObjectBuilder builder) {
		super(builder);
    }
	/**
