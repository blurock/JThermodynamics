...
public class NancyLinearFormToMolecule {
     ...
     * @return The molecule
     */
    public IAtomContainer convert(String linearform) throws SQLException {
 ...
 */
    private void addNodeToMolecule(AtomGroupStringNode node,
        ...
        //node = ringInfo.get(cycle);
            ...
            // Need to change
            atm = new Atom("R");
            atm.setSymbol(atminfo.atomGroup.toUpperCase());
        }
        if (atm != null) {
 ...
 * @return the molecule
 */
    private IAtomContainer convertToMolecule() throws NullPointerException {
