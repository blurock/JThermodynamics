...
public class NormailizeStructureFromSmiles {
        ...
        public IAtomContainer moleculeFromSmiles(String smiles) {
        ...
        try {
            ...
            molecule = (IAtomContainer) parser.parseSmiles(smiles);
    ...
    public void addHydrogens(IAtomContainer molecule) throws CDKException {
