...
public class TestRadicals {
    ...
    public void findRadicalsInMolecule() {
        try {
            ...
            IAtomContainer mol = nancy.convert(molS);
    ...
    public void testMoleculeMatch() {
        try {
            ...
            String mol3S = "ch(.)//ch2";
            String mol4S = "ch(.)//R";
            IAtomContainer mol1 = nancy.convert(mol1S);
            MoleculeUtilities.assignIDs(mol1);
            IAtomContainer mol2 = nancy.convert(mol2S);
            MoleculeUtilities.assignIDs(mol2);
            IAtomContainer mol3 = nancy.convert(mol3S);
            MoleculeUtilities.assignIDs(mol3);
            IAtomContainer mol4 = nancy.convert(mol4S);
