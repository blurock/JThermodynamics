...
public class NASAPolynomialFromBensonBurcat extends NASAPolynomialFromBenson {
    ...
    double B;
    public NASAPolynomialFromBensonBurcat(BensonThermodynamicBase b, IAtomContainer molecule, ThermoSQLConnection c) throws SQLException, CDKException, ClassNotFoundException, IOException, ThermodynamicComputeException {
        connection = c;
    ...
    public void heatCapacityAtInfinityAndZero(IAtomContainer mol) throws CDKException, IOException {
        double cp = 0.0;
