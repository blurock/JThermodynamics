...
public class SubstructuresFromSymmetry {
    ...
    private ArrayList<IAtomContainer> isolateMoleculesFromPairs(ArrayList<SymmetryPairedWithMolecule> pairs) {
    ...
    private boolean monoValent(IAtomContainer molecule, String name) {
        boolean ans = false;
    ...
    private class SymmetryPairedWithMolecule {
        ...
        public SymmetryPairedWithMolecule(IAtomContainer molecule, HashSet<String> atoms) {
    ...
    private ArrayList<IAtomContainer> generateStructures(
    ...
    private void generateStructures(
        ...
        IAtomContainer molecule = pair.molecule;
        ...
        while(iter.hasNext()) {
            String name = iter.next();
            IAtomContainer newmolecule = generateStructure(molecule, tosubstitute,name);
     ...
     */
    private IAtomContainer generateStructure(IAtomContainer molecule, Vector<String> tosubstitute, String newname) {
        IAtomContainer newmolecule = new AtomContainer(molecule);
     ...
     */
    private void substituteAtomInMolecule(IAtomContainer newmolecule, String atmname, String newname) {
        ...
        Atom subatm = new Atom("R");
        subatm.setSymbol(newname);
        subatm.setID(id);
    ...
    private int findAtomNumber(IAtomContainer newmolecule, String atmname) {
        int id = 0;
     ...
     */
    private IAtom findAtomInMolecule(IAtomContainer newmolecule, String atmname) {
        IAtom found = null;
