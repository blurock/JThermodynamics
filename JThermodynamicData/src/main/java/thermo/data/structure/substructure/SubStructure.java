...
public class SubStructure {
    protected IAtomContainer substructure;
    ...
    public SubStructure(IAtomContainer substructure, String source) {
    ...
    public List<List<RMap>> structureMatch(SubStructure molecule) throws CDKException {
        ...
        List<List<RMap>> map = matches.getAtomMatches((IAtomContainer) molecule.getSubstructure(), substructure);
        return map;
    }
