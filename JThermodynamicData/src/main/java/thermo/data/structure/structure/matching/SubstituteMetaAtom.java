...
public class SubstituteMetaAtom {
     ...
     */
    private void eliminateAtomsFromMolecule(IAtomContainer molecule, List<IAtom> atoms) {
     ...
     */
    private void eliminateBondsFromMolecule(IAtomContainer molecule, List<IBond> subbonds) {
     ...
     */
    private void modifyConnectionBonds(IAtomContainer molecule, IAtom matm, List<IAtom> atoms, List<IBond> connections) {
