...
public class MoleculeUtilities {
    ...
    public static String toString(IAtomContainer mol) {
    ...
    public static void normalizeAtomNames(IAtomContainer mol) throws IOException {
    ...
    public static void normalizeMolecule(IAtomContainer mol) throws IOException {
