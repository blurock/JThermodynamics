...
public class TestStructureMatching {
    ...
    public void testGeneralCarbonInAlkane() throws CDKException, IOException {
        try {
            ...
            IAtomContainer ncarbon = norm.getNormalizedMolecule(cmlcarbon);
            IAtomContainer nethane = norm.getNormalizedMolecule(cmlethane);
    ...
    private void getAndPrintAtomMatches(IAtomContainer mol1, IAtomContainer mol2) {
    ...
    private void getAndPrintBondMatches(IAtomContainer mol1, IAtomContainer mol2) {
        GetSubstructureMatches match = new GetSubstructureMatches();
        try {
    ...
    private void getAndPrintMatcheForAtom(IAtomContainer mol1, IAtomContainer mol2, int atmnum) {
        GetSubstructureMatches match = new GetSubstructureMatches();
        try {
